...
Install the dependency, then run the fetch script from this directory:

    pip install datasets
    python3 ../scripts/fetch_corpus.py --out corpus.txt --per-lang 4000

This produces corpus.txt, one paragraph per line: 94,504 paragraphs and
25,469,281 characters across 29 languages spanning Bantu, Afro-Asiatic,
Volta-Niger, Senegambian, Mande, Ubangian, Austronesian and Germanic
families. Akan (ak) fails to load and is skipped.
